                ...
                <div className="flex flex-col ">
                    <div className="">
                        <div className="relative h-62 w-full mb-3">
                            ...
                            <img src={props.image} alt="Just a flower" className=" w-full   object-fill  rounded-2xl" style={{ height: '20rem' }} />
                        </div>
                        <div className="flex-auto justify-evenly">
                            <div className="flex flex-wrap ">
                                <div className="w-full flex-none text-sm flex items-center text-gray-600">
                                    ...
                                    <span className="text-gray-400 whitespace-nowrap mr-3">{props.rating.rate}</span><span className="mr-2 text-gray-400">{props.rating.count}</span>
                                </div>
                                <div className="flex items-center w-full justify-between min-w-0 ">
                                    <h2 className="text-lg mr-auto cursor-pointer text-gray-200 hover:text-purple-500 truncate ">{props.title}</h2>
                                    <div className="flex items-center bg-green-400 text-white text-xs px-2 py-1 ml-3 rounded-lg">
                                        INSTOCK</div>
                                </div>
                            </div>
                            <div className="text-xl text-white font-semibold mt-1">${props.price}</div>
